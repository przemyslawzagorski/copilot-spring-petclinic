# Ćwiczenia: Moduł 10 (Copilot Python SDK)

| # | Ćwiczenie | Plik | Czas |
|---|-----------|------|------|
| 25 | Setup SDK i autoryzacja | [ex_25](exercises/ex_25_setup_sdk.md) | ~15 min |
| 26 | Pierwsza sesja — hello chat | [ex_26](exercises/ex_26_hello_chat.md) | ~15 min |
...
- Aktywne konto GitHub z Copilot (free tier OK)
- Wirtualne środowisko (zalecane: `.venv` w katalogu modułu)
